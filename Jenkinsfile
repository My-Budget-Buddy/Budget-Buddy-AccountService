    ...
    stages {
        ...
        stage('Build and Push Docker Image for Staging') {
            ...
            steps {
                ...
                /kaniko/executor --cleanup --cache=false --dockerfile=Dockerfile.dev --context=dir://. --destination=924809052459.dkr.ecr.us-east-1.amazonaws.com/account-service:latest
              '''
                    }
                }
            }
